...
function fancyStringFunc(s1) {
    var strArray = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        strArray[_i - 1] = arguments[_i];
    }
    return strArray.map(function (x) { return s1 + x; });
}
...
var randomArray2 = [];
randomArray1.forEach(function (element) { return randomArray2.push(element * 2); });
var map1 = new Map();
map1.set('a', 1);
map1.set('b', 2);
map1.set('c', 3);
randomArray.push.apply(randomArray, randomArray1);
